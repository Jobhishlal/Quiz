...
const AuthLayout: React.FC = () => {
    return (
        <div className="flex h-screen w-full bg-white overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-0 overflow-hidden bg-gray-50">
                <div className="relative w-full h-full flex flex-col items-center justify-center">
                    <img
                        src="/background_orginal.png"
                        alt="Welcome"
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full px-8 text-center pt-20">
                        <div className="relative w-80 h-64 mb-2">
                            ...
                            <div
                                className="absolute top-0 left-10 w-28 h-28 rounded-full border-4 border-white overflow-hidden shadow-lg z-10"
                                style={{
                                    backgroundImage: "url('/avater 1.png')",
                            ...
                            <div className="absolute top-4 right-8 w-28 h-28 rounded-full border-4 border-white overflow-hidden shadow-lg bg-[#E6D0C5] z-10"
                                style={{
                                    backgroundImage: "url('/avater 2.png')",
                                    backgroundSize: "cover",
                                    backgroundPosition: "center",
                                    backgroundRepeat: "no-repeat",
                                }}
                            ...
                            <div
                                className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-28 h-28 rounded-full border-4 border-white overflow-hidden shadow-lg z-50"
                                style={{
                                    backgroundImage: "url('/avater 3.png')",
                                    backgroundSize: "cover",
                                    backgroundPosition: "center",
                                    backgroundRepeat: "no-repeat",
                                }}
